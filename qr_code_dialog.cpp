...
void QRCodeDialog::setupUI(const QString &userId, const QString &secret)
{
    ...
    headerLabel->setStyleSheet("QLabel { color: #FFFFFF; font-size: 16px; font-weight: bold; background: transparent; }");
    ...
    secretLabel->setStyleSheet("QLabel { font-family: monospace; font-size: 11.5pt; font-weight: 500; color: #000000; padding: 5px 10px 10px 10px; margin-left: 7px; }");

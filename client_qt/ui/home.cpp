...
// =======
// >>>>>>> 071a41784627dd5d574edbc2b6145a7e328a442e
    ...
    , currentSearchEndDate(QDate())
{
    ...
    // 차트 위젯이 UI에서 삭제되었으므로 메인 차트 매니저는 생성하지 않음
    // 팝업에서만 차트를 사용하므로 이 부분 주석 처리
    /*
...
void Home::processChartDataResponse(const QJsonObject &response)
{
    ...
    for (const QJsonValue &value : dataArray)
    {
        ...
        // 메인 차트는 삭제되었으므로 메인 차트 매니저 부분 주석 처리
        /*
        // 차트에 전달
        if (m_errorChartManager)
        {
